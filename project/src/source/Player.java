...
public class Player extends Person {
	...
	public void startHavingRadarBonus() {
		startTimeForRadarBonus = Judge.getStaticTime();
		hasRadarBonus++;
	}

	public void startHavingSpeedUpBonus() {
		startTimeForSpeedUpBonus = Judge.getStaticTime();
		hasSpeedUpBonus++;
		this.speed *= 2;
	}

	public void startHavingJumpBonus() {
		startTimeForJumpBonus = Judge.getStaticTime();
		hasJumpBonus++;
	}

	public void startHavingStonedBonus() {
		startTimeForStonedBonus = Judge.getStaticTime();
		hasStonedBonus++;
	}
